...
2. Go to your repository at [collective/hange-gallery](https://github.com/collective/hange-gallery).
...
- [Backend Tests Workflow](https://github.com/collective/hange-gallery/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/collective/hange-gallery/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/collective/hange-gallery-backend`) and Frontend (`ghcr.io/collective/hange-gallery-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of hange-gallery.meow.com](https://github.com/collective/hange-gallery/actions/workflows/manual-deploy.yml).
