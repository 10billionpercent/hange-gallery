...
2. Go to your repository at [10billionpercent/hange-gallery](https://github.com/10billionpercent/hange-gallery).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `hange-gallery.meow.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | hange-gallery.meow.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | hange-gallery.meow.com |
...
- [Backend Tests Workflow](https://github.com/10billionpercent/hange-gallery/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/10billionpercent/hange-gallery/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/10billionpercent/hange-gallery-backend`) and Frontend (`ghcr.io/10billionpercent/hange-gallery-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of hange-gallery.meow.com](https://github.com/10billionpercent/hange-gallery/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/hange-gallery.meow.com.yml` stack.
