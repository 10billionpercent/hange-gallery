...
DEPLOY_ENV=prod
DEPLOY_HOST=hange-gallery.meow.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for hange-gallery.meow.com, enable SSH, and install a supported version of Python 3 on that system.
...
prod:
  hosts:
    hange-gallery.meow.com:
      ansible_user: root
      host: hange-gallery
      hostname: hange-gallery.meow.com
```
...
Deploy the stack defined in `devops/stacks/hange-gallery.meow.com.yml` to the remote server with:
