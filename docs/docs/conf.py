...
# hange-gallery build configuration file
...
linkcheck_ignore = [
    ...
    r"https://github.com/collective/hange_gallery/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/collective/hange_gallery",
    ...
    "repository_url": "https://github.com/collective/hange_gallery",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/collective/hange_gallery/edit/main/docs/",
# }
...
ogp_site_name = "hange-gallery Documentation"
ogp_type = "website"
...
htmlhelp_basename = "hange-galleryDocumentation"
...
latex_documents = [
    (
        "index",
        "hange-galleryDocumentation.tex",
        "hange-gallery Documentation",
