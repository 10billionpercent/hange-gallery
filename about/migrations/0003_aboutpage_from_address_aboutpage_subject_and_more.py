# Generated by Django 6.0.2 on 2026-03-09 04:49
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('about', '0002_remove_aboutpage_content_aboutpage_body'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='about.aboutpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
